...
void main() {
    ...
    vec4 rotation3 = vec4(
        snoise(vec4(position*0.01, (u_time + 100.0)*0.001)),
        snoise(vec4(position*0.01, (u_time + 200.0)*0.001)),
        snoise(vec4(position*0.01, (u_time + 300.0)*0.001)),
        snoise(vec4(position*0.01, (u_time + 400.0)*0.001))
    );
